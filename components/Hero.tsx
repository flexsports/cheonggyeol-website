  ...
  return (
    <section className='relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10 text-center text-white px-4 md:pr-12 md:px-0'>
        <h1 className='text-2xl md:text-6xl font-bold mb-3 md:mb-4 drop-shadow-lg leading-tight'>
          공간의 가치를 더하는
          <br />
          프리미엄 청소 서비스
        </h1>
        ...
        <div className='flex flex-nowrap items-center justify-center gap-2 md:gap-4 px-2'>
          <div className='bg-sky-600/85 text-white px-3 py-1.5 md:px-6 md:py-2 rounded-4xl font-semibold text-xs md:text-lg shadow-lg whitespace-nowrap'>
            전국출장
          </div>
          <div className='bg-sky-600/85 text-white px-3 py-1.5 md:px-6 md:py-2 rounded-4xl font-semibold text-xs md:text-lg shadow-lg whitespace-nowrap'>
            당일예약
